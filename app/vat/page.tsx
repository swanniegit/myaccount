...
export default function VATPage() {
  ...
  return (
    <div className="p-5 max-w-4xl">
      ...
      {/* Period header */}
      <div className="mb-4">
        <div className="text-base font-semibold">VAT 201 · March 2026</div>
        <div className="text-xs" style={{ color: 'var(--ink-2)' }}>
          Period 202603 · due 25 May · 14 days · eFiling user TG-44
        </div>
      </div>
      ...
      <div className="flex gap-4">
          ...
          {step === 1 && (
            <>
              ...
              <div
                ...
                style={{ border: '1px solid var(--paper-edge)', color: 'var(--ink-2)', fontStyle: 'italic' }}
              >
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex justify-between font-semibold pt-2" style={{ borderTop: '1px solid var(--paper-edge)' }}>
                  ...
                  <span className="font-mono" style={{ color: 'var(--accent)' }}>
                    R {payable.toLocaleString('en-ZA', { minimumFractionDigits: 2 })}
                  </span>
                </div>
              </div>
        ...
        >
          <div className="text-xs font-medium mb-3">This return</div>
          <div className="space-y-1.5 mb-3 text-xs">
            ...
            <div
              ...
              style={{ borderBottom: '1px solid rgba(217,119,87,0.3)' }}
            >
              <span style={{ color: 'var(--ink-2)' }}>Input VAT (Box 20)</span>
              <span className="font-mono">{inputVAT.toLocaleString('en-ZA', { minimumFractionDigits: 2 })}</span>
            </div>
          ...
          {boxes.map(b => (
            <tr key={b.box} style={{ borderBottom: '1px solid var(--paper-edge)', background: 'var(--surface)' }}>
              ...
              <td className="px-3 py-2 font-mono text-right">
                {b.excl != null ? b.excl.toLocaleString('en-ZA', { minimumFractionDigits: 2 }) : '—'}
              </td>
              <td className="px-3 py-2 font-mono text-right">
                {b.vat != null ? b.vat.toLocaleString('en-ZA', { minimumFractionDigits: 2 }) : '—'}
              </td>
            </tr>
          ))}
        </tbody>
        <tfoot>
          <tr style={{ background: 'var(--accent-soft)', borderTop: '2px solid var(--paper-edge)' }}>
            ...
            <td className="px-3 py-2 font-mono text-right font-semibold">
              {totalVAT.toLocaleString('en-ZA', { minimumFractionDigits: 2 })}
            </td>
          </tr>
        </tfoot>
      </table>
