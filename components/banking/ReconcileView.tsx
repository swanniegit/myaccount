...
export default function ReconcileView({ account, period }: { account: BankAccountLite; period: MonthValue }) {
  ...
  const masked       = account.account_number.slice(0,4) + '...' + account.account_number.slice(-4)
                ...
                {isAllocating && (
                  <div className="border-t border-paper-edge px-3 py-3 text-xs"
                    ...
                    <div className="flex gap-2 flex-wrap items-end">
                      ...
                      <button className="btn btn-sm btn-primary" onClick={() => submitAllocate(txn.id)} disabled={allocating2}>
